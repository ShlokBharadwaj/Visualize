  ...
  return (
    <header className="bg-white shadow-lg p-4 flex justify-between items-center">
      <div className="w-full">
        ...
        />
        <AccountCircleOutlined className="absolute right-6 top-7 text-gray-400 rounded-md hover:bg-gray-200" />
        <NotificationsOutlined className="absolute right-14 top-7 text-gray-400 rounded-md hover:bg-gray-200" />
        <LightModeOutlined className="absolute right-[5.5rem] top-7 text-gray-400 rounded-md hover:bg-gray-200" />
      </div>
    </header>
  );
};
